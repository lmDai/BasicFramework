...
import cn.yznu.basicframework.model.http.ApiConstants;

import static cn.yznu.basicframework.model.http.ApiConstants.OPEN_ACTIVITY_KEY;
...
public class IntentUtils {
    ...
    public void goActivity(Context _this, Class<? extends Activity> _class, Bundle bundle) {
        intent.putExtra(ApiConstants.BUNDLE, bundle);
        intent.setClass(_this, _class);
        _this.startActivity(intent);
        _this = null;
    }
